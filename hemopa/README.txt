...
a persistence unit "hemopaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "hemopa\pom.xml":
...
artifact ("hemopa.war") is already built. You can build
