...
import br.com.j.hemopa.digital.infra.model.Filter;
import br.com.j.hemopa.digital.model.Car;
import br.com.j.hemopa.digital.service.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                br.com.j.hemopa.digital.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? br.com.j.hemopa.digital.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? br.com.j.hemopa.digital.infra.model.SortOrder.DESCENDING
                            : br.com.j.hemopa.digital.infra.model.SortOrder.UNSORTED;
                }
